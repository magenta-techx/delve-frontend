...
const LandingPageNavbar = () => {
  ...
  return (
    <nav
      className={cn(
        'relative z-[20] transition-colors duration-300 flex h-14 w-full items-center justify-between px-4 md:px-16 md:backdrop-blur-lg lg:h-20 lg:px-24 xl:h-24',
              ...
              <>
                {isMobile ? (
                  <LinkButton
                    ...
                    className={cn(
                      'mr-2 md:hidden',
                      pageHasBlackBg && 'text-white text-xs'
                    )}
                  >
                    Sign in
                  </LinkButton>
    ...
    <>
      {
        isMobile ?
          <Sheet>
            ...
            <SheetContent side="right" className="w-full sm:max-w-full p-0 flex flex-col bg-[#FAFAFA] border-none">
