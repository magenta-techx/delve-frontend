...
const LandingPageNavbar = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const threshold = Math.min(600, 0.95 * vh);
  ...
  return (
    <nav
      className={cn(
        'relative z-[45] flex h-14 w-full items-center justify-between px-4 transition-colors duration-300 md:px-16 md:backdrop-blur-lg lg:h-20 lg:px-24 xl:h-24',
