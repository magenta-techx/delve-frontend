...
export default function CollaborationForm() {
  ...
  return (
    <div className='grid h-screen w-full grid-rows-[max-content,1fr] gap-3 overflow-hidden py-16 xl:pt-28 xl:pb-24'>
      ...
      <section className='mx-auto grid w-full max-w-7xl gap-12 space-y-4 xl:grid-cols-2 xl:gap-20'>
        <form className='flex flex-col gap-5 lg:pt-8'>
          <h1 className='text-lg font-semibold md:text-xl mb-4'>
          ...
          <section className='mt-8'>
            <h5 className='font-medium'>Group Members</h5>
        ...
        <article className='custom-scrollbar flex flex-col overflow-y-auto rounded-lg bg-[#FFFFFF] p-6 xl:h-full'>
          {/* Preview Header */}
          <div className='mb-6 flex items-center justify-between border-b pb-4'>
            <h2 className='text-2xl font-bold text-[#0D121C]'>Preview</h2>
            <button
              type='button'
              onClick={() => {
                setInvitedMembers([]);
          ...
          {/* Group Name Section */}
          <div className='mb-6'>
            <h3 className='mb-2 text-sm font-normal text-[#9AA4B2]'>
              Group name
            </h3>
            {watch('name') ? (
          ...
          {(currentUser || invitedMembers.length > 0) && (
            <div className='mb-6'>
              <h3 className='mb-4 text-sm font-normal text-[#9AA4B2]'>
                Group Members
              </h3>
