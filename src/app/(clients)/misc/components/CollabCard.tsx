...
export default function CollabCard({ collab }: CollabCardProps) {
  ...
  const handleConfirmDelete = async () => {
    try {
      await deleteMutation.mutateAsync({ collab_id: collab.id });
      ...
      >
        ...
        <div className='z-2 relative flex h-full flex-col gap-4'>
          ...
          <div className='flex flex-1 flex-col justify-between gap-4 md:gap-6 lg:px-2'>
            <div>
              <h6 className='text-xs text-[#9AA4B2] md:text-sm'>Description</h6>
      ...
      <Dialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Are you sure you want to delete &quot;{collab.name}&quot;? This
              action cannot be undone and all members will lose access to this
              collaboration.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
