          ...
          >
            <div className='mt-auto flex w-full flex-col gap-2 divide-y divide-white pb-3'>
              <div className='flex items-start gap-2'>
                ...
                <div>
                  <h3 className='font-semibold truncate' style={{ fontSize: getFluidFontSize(0.675, 1.1, 0.0035) }}>{header}</h3>
                  <p className='line-clamp-2' style={{ fontSize: getFluidFontSize(0.45, 0.8, 0.0025) }}>{desc}</p>
                </div>
              </div>
              <div className='flex items-center gap-4 justify-between pt-2 w-full overflow-hidden'>
                <div className='flex items-center gap-2 basis-4/5 truncate'>
                  ...
                  <span className='text-[#FFE6D5] truncate' style={{ fontSize: getFluidFontSize(0.45, 0.8, 0.0025) }}>
                    {address}
                  </span>
                </div>
