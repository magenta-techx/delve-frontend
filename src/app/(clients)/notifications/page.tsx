...
export default function NotificationsPage() {
    ...
    return (
        <div className='min-h-screen bg-[#FCFCFD] pb-20 pt-20 md:pt-28 lg:pt-32'>
                    ...
                    {!notificationsLoading && notifications.length === 0 && (
                        <div className='flex flex-col items-center justify-center px-6 py-20 text-center'>
                            ...
                            <p className='mt-2 max-w-sm text-sm text-[#94A3B8]'>
                                We&apos;ll let you know when there&apos;s new collaboration invites, profile views or account updates.
                            </p>
                        </div>
                    )}
