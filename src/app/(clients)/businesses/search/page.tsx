...
const BusinessSearchPage = (): JSX.Element => {
  ...
  // Backend expects exact category and state names, not IDs
  const categoryNameForApi = categoryMatch?.name;
  const locationNameForApi = locationMatch?.name;
  ...
  const {
    ...
    ...(locationNameForApi && { state: locationNameForApi }),
  });
  ...
  return (
    <div className='container relative mx-auto flex min-h-dvh w-full flex-1 flex-col gap-10 bg-[#F8FAFC] px-4 py-24 md:pt-32 lg:flex-row lg:px-6'>
      {/* Mobile Bottom Sheet */}
        ...
        >
          ...
          <div className='flex-1 overflow-y-auto px-4 py-6'>
            <div className='flex flex-col gap-6'>
              ...
              {/* States */}
              <section className='border-t border-[#E3E8EF] pt-2'>
                <button
                  type='button'
              ...
              {hasAnyFilter && (
                <section className='border-t border-[#E3E8EF] pt-4'>
                  <Button
                    variant='neutral'
                    size='sm'
                    className='w-full'
