...
const BusinessesLandingPage = () => {
  ...
  return (
    <div className='flex flex-col justify-center overflow-y-hidden'>
      ...
      {/* MARQUEE SECTION */}
      <section className='relative mb-1 flex w-full flex-col items-center justify-center gap-6 py-10 sm:mt-32 sm:min-h-[543px] sm:py-16'>
      ...
      >
        <section className='my-12 flex w-full flex-col justify-center sm:px-0'>
          <h1 className='mx-auto mb-4 w-full text-center font-karma text-2xl max-md:max-w-[20ch] max-md:text-balance sm:max-w-screen-md sm:text-3xl sm:font-semibold md:mb-10 xl:text-4xl'>
