                ...
                <div className='flex items-center gap-3'>
                  {(
                    ...
                    return (
                      <Link
                        key={key}
                        className='flex items-center gap-2 rounded-md bg-[#00000047] p-1.5 text-xs hover:bg-[#00000076]'
                        href={url}
                        target='_blank'
                        rel='noopener noreferrer'
                      >
              ...
              <Card className='border !border-[#E3E8EF] p-2 ring-0 md:p-4'>
                <div className='space-y-4'>
                  ...
                  <p className='flex items-center gap-2 text-xs'>
                    ...
                    {business.address || (
                      <span className='font-medium text-[#6E44FF]'>
                        Online Store
                      </span>
                    )}
                  </p>
                  ...
                  <div className='flex items-center gap-3 pt-4'>
                    {[
                      ...
                      return (
                        <Link
                          key={key}
                          className='flex items-center gap-2 rounded-md bg-[#edeaea] p-1.5 text-xs hover:bg-[#e4e4e4]'
                          href={url}
                          target='_blank'
                          rel='noopener noreferrer'
                        >
              ...
              {business.business_hours && (
                <div className=''>
                  <div className='flex items-center justify-between border-b pb-4'>
                    <h3 className='font-karma text-2xl font-medium text-[#2F3D4C]'>
                      Open
                    </h3>
                  </div>
                          ...
                          {group.is_open ? (
                            <>
                              <div className='flex items-start gap-1.5'>
                                <span className='font-karma text-3xl font-bold text-[#697586]'>
                                  {formatBusinessTime(group.open_time)?.hour}
                                </span>
                                <div className='flex flex-col justify-between gap-2 py-1 text-[10px] font-medium leading-[10px] text-[#667085]'>
                                  <span>
                                    {
                                      formatBusinessTime(group.open_time)
                                        ?.period[0]
                                    }
                                  </span>
                                  <span>
                              ...
                              <span className='text-3xl font-thin text-[#D0D5DD]'>
                                —
                              </span>
                              <div className='flex items-start gap-1.5'>
                                <span className='font-karma text-3xl font-bold text-[#697586]'>
                                  {formatBusinessTime(group.close_time)?.hour}
                                </span>
                                <div className='flex flex-col justify-between gap-2 py-1 text-[10px] font-medium leading-[10px] text-[#667085]'>
                                  <span>
                                    {
                                      formatBusinessTime(group.close_time)
                                        ?.period[0]
                                    }
                                  </span>
                                  <span>
                            ...
                            <span className='text-base font-normal text-[#98A2B3]'>
                              Closed
                            </span>
                          )}
                        </div>
