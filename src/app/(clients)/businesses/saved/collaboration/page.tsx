...
export default function CollaborationsPage() {
  return (
    <div className='container relative mx-auto flex w-full flex-col items-center overflow-x-hidden px-4 max-md:pb-28'>
      <header className='z-10 mt-20 w-full md:mt-28'>
