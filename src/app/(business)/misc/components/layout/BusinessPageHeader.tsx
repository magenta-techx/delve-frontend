...
export const BusinessPageHeader = ({
  ...
  return (
    <header className={cn('flex flex-col', className)}>
      {!!title || !!description ? (
        <div className={cn('p-4 !pb-1 lg:p-6', containerClassName)}>
      ...
      {marketPlace && (
        <div className='hidden items-center justify-end gap-4 p-1.5 md:flex md:p-4'>
          ...
          {!isMobile && (
            <>
              {!!user?.first_name && (
                <Link
                  href='/profile'
                  className='ml-1 flex w-max max-w-36 items-center gap-1 truncate text-left text-[0.9rem] font-medium capitalize'
                >
                  <svg
                    width='26'
                    height='26'
