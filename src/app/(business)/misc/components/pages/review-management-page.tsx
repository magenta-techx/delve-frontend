  ...
  const [reviews, setReviews] = useState<Review[]>([
    {
      ...
      rating: 5,
      comment:
        'Excellent service! The team was professional and attentive to every detail.',
      date: '2 weeks ago',
      status: 'published',
      helpful: 24,
      unhelpful: 2,
        ...
        >
          <TabsList>
            <TabsTrigger value='published'>
              Published ({getFilteredReviews('published').length})
            </TabsTrigger>
            <TabsTrigger value='pending'>
              Pending ({getFilteredReviews('pending').length})
            </TabsTrigger>
            <TabsTrigger value='hidden'>
              Hidden ({getFilteredReviews('hidden').length})
            </TabsTrigger>
          </TabsList>
