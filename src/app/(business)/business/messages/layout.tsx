  ...
  return (
    ...
    >
      ...
      <div className='flex grow gap-x-4 overflow-hidden'>
        ...
        >
          {!isLoadingChats && (chats?.data?.length ?? 0) > 0 && (
          ...
          <div className='custom-scrollbar flex-1 space-y-1 overflow-y-scroll'>
                ...
                <EmptyState
                  ...
                  description={
                    searchQuery
                      ...
                      : 'Messages to ask question, check availabilty or, make a booking would appear here.'
                  }
                />
              </div>
            ) : (
            ...
            {pinConfirm && (
              <div className='fixed inset-0 z-[51] flex items-center justify-center bg-black/40 p-4'>
        ...
        <section
          className={cn(
            ...
            !current_chat_id && !hasNoChats ? 'hidden lg:block' : 'flex'
          )}
        >
          {isLoadingChats ? (
