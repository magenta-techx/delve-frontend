    ...
    <main className='relative flex flex-col items-center overflow-x-hidden'>
      ...
      <div className="sm:w-[1540px] mt-20 z-10">
        <div className="flex items-center justify-between w-full mb-4">
          ...
          <button className="sm:h-[52px] sm:w-[167px] bg-primary/10 text-primary font-semibold text-[16px] flex items-center justify-center rounded-lg gap-2"> <BaseIcons value='people-outlined-primary' /><p>Collaboration</p></button>
        </div>
