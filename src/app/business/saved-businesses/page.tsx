      ...
      <div className='z-10 mt-20 sm:w-[1540px]'>
        <div className='mb-4 flex w-full items-center justify-between'>
          <h1 className='flex items-center gap-3 font-inter text-[25px] font-semibold'>
            <ExploreBaseIcons value='listing-white-and-black-solid' />
            <p>Saved Businesses</p>
          </h1>
          <button
            className='flex items-center justify-center gap-2 rounded-lg border-[1px] border-[#D9D6FE] bg-primary/10 text-[16px] font-semibold text-primary sm:h-[52px] sm:w-[167px]'
