...
const LocationCard = ({ name, imageUrl }: LocationProps): JSX.Element => {
  return (
    <Link href={`businesses/search?location=${name}`} className='group relative flex w-36 max-md:!aspect-[160/175] items-center justify-center overflow-hidden rounded-2xl sm:h-[210px] sm:w-full'>
