...
const BuinessHero = (): JSX.Element => {
  return (
    <div className='flex flex-col items-start justify-between px-20 pb-6 pt-10 sm:flex-row sm:pb-20 sm:pt-40'>
      <h1 className='w-full font-karma text-[34px] font-semibold leading-tight sm:w-[650px] sm:text-[58px]'>
